            ...
            <form action="{{ route('bpb.store') }}" method="post">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="departemen" class="form-control {{ $errors->has('departemen') ? 'is-invalid' : ''}}" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text"  name="satuan_sisa" class="form-control {{ $errors->has('satuan_sisa') ? 'is-invalid' : ''}}" required>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="permintaan" class="form-control {{ $errors->has('permintaan') ? 'is-invalid' : ''}}" required>
                        {!! $errors->first('permintaan', '<span class="invalid-feedback">:message</span>') !!}
                    </div>
                    <div class="col-md-3">
                        <label for="">Satuan</label>
                        <input type="text" name="satuan_permintaan" class="form-control {{ $errors->has('satuan_permintaan') ? 'is-invalid' : ''}}" required>
